Public Class frmMain
    ...
    Sub OldCode()
        ...
        'For X = 0 To objImage.Size.Width - 1
        '    For Y = 0 To objImage.Size.Height - 1
        '        If Y = 0 Then
        '            If intHeights(X, Y) > 0 Then
        '                'TopTop #1
        '                objTriangleC += 1
        '                With objTriangles(objTriangleC)
        '                    .intX1 = X + 1
        ...
        '                    .intX3 = X + 1
        '                    .intY3 = Y
        '                    .intZ3 = intHeights(X, Y)
        '                End With

        '            End If
        '        Else
        '            If intHeights(X, Y - 1) <> intHeights(X, Y) Then
        '                'Top #1
        '                objTriangleC += 1
        '                With objTriangles(objTriangleC)
        '                    .intX1 = X + 1
        ...
        '                    .intX1 = X
        '                    .intY1 = Y
        '                    .intZ1 = intHeights(X, Y - 1)

        '                    .intX2 = X + 1
        '                    .intY2 = Y
        '                    .intZ2 = intHeights(X, Y - 1)
        ...
        '            End If
        '        Else
        '            If intHeights(X - 1, Y) <> intHeights(X, Y) Then
        '                'Left #1
        '                objTriangleC += 1
        '                With objTriangles(objTriangleC)
        '                    .intX1 = X
        ...
        '        If Y = objImage.Size.Height - 1 Then
        '            If intHeights(X, Y) > 0 Then
        '                'BottomBottom #1
        '                objTriangleC += 1
        '                With objTriangles(objTriangleC)
        ...
        '            End If
        '        End If
        '        If X = objImage.Size.Width - 1 Then
